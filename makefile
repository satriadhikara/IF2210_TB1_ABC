...
CMDFILES = $(CMDDIR)/Commands.cpp $(CMDDIR)/Next.cpp $(CMDDIR)/CetakPenyimpanan.cpp $(CMDDIR)/CetakPeternakan.cpp $(CMDDIR)/CetakLadang.cpp $(CMDDIR)/PungutPajak.cpp $(CMDDIR)/TambahPemain.cpp
