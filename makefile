...
CMDFILES = $(CMDDIR)/Commands.cpp $(CMDDIR)/Next.cpp $(CMDDIR)/CetakPenyimpanan.cpp $(CMDDIR)/CetakPeternakan.cpp $(CMDDIR)/CetakLadang.cpp $(CMDDIR)/PungutPajak.cpp $(CMDDIR)/TambahPemain.cpp $(CMDDIR)/Tanam.cpp $(CMDDIR)/Ternak.cpp $(CMDDIR)/Makan.cpp $(CMDDIR)/Membeli.cpp $(CMDDIR)/Menjual.cpp $(CMDDIR)/Simpan.cpp
